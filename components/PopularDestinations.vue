...
export default {
  ...
  data() {
    return {
      ...
      itemsPerPage: 4,
      cities: [
        { name: 'Париж', image: '/travelpulse-nuxt/eaa255f4fd9a48dcedb6ba913c1fd03c3f2520a2.png' },
        { name: 'Рим', image: '/travelpulse-nuxt/9aea977b0df1a0b23180692be43e1581cb6e6c1c.png' },
        { name: 'Бали', image: '/travelpulse-nuxt/be487c84ed73cbb733f7e9259500018c71aa94dc.png' },
        { name: 'Байкал', image: '/travelpulse-nuxt/1d4d305ee0eea20fac8ff08913324b92fe3d970a.png' },
        { name: 'Лондон', image: '/travelpulse-nuxt/9d8a25bcb6d03e5af531cb6a15571954.png' },
        { name: 'Токио', image: '/travelpulse-nuxt/TOKIO.png' },
        { name: 'Нью-Йорк', image: '/travelpulse-nuxt/592642d3fa8520ccd61a2539f49f4f37.png' },
        { name: 'Дубай', image: '/travelpulse-nuxt/dubai.png' },
      ],
    };
  },
  computed: {
