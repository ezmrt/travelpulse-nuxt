...
export default {
  ...
  data() {
    return {
      ...
      itemsPerPage: 4,
      cities: [
        { name: 'Париж', image: '/eaa255f4fd9a48dcedb6ba913c1fd03c3f2520a2.png' },
        { name: 'Рим', image: '/9aea977b0df1a0b23180692be43e1581cb6e6c1c.png' },
        { name: 'Бали', image: '/be487c84ed73cbb733f7e9259500018c71aa94dc.png' },
        { name: 'Байкал', image: '/1d4d305ee0eea20fac8ff08913324b92fe3d970a.png' },
        { name: 'Лондон', image: '/9d8a25bcb6d03e5af531cb6a15571954.png' },
        { name: 'Токио', image: '/TOKIO.png' },
        { name: 'Нью-Йорк', image: '/592642d3fa8520ccd61a2539f49f4f37.png' },
        { name: 'Дубай', image: '/dubai.png' },
      ],
    };
  },
  computed: {
