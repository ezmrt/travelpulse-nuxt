    ...
    <div class="container">
      <div class="header__top">
        <div class="header__logo">
          <a href="#">
            <img 
              src="/images/5f07cc5d3db5b2c4c8208e7b32e15896d4664c1d.png" 
              alt="Travel Pulse" 
      ...
      <div class="modal">
        ...
        <div class="modal__social">
          <button class="modal__social-btn">
            <img 
              src="/images/87cf34858b96ae3aeead66058ed8bcfc7e2e1978.png" 
              alt="Facebook" 
          ...
          <button class="modal__social-btn">
            <img 
              src="/images/7f42d49b6919fba36ba2449fa426a722d691d6c6.png" 
              alt="Google" 
              class="modal__social-icon" 
            />
          </button>
          <button class="modal__social-btn">
            <img 
              src="/images/042b9d98284a60ff1e53dd66032036cda004c5f7.png" 
              alt="Apple" 
              class="modal__social-icon" 
            />
          </button>
